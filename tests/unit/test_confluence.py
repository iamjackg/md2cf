...
def test_get_page_with_title(confluence, mocker):
    ...
    test_page_id = 12345
    test_return_value = bunchify({
        'results': [{'id': test_page_id}]
    })
...
def test_get_page_with_all_parameters(confluence, mocker):
    ...
    page = confluence.get_page(page_id=test_page_id, title=test_page_title, space_key=test_page_space)
...
def test_create_page_with_parent(confluence):
    ...
    confluence.create_page(space=test_space, title=test_title, body=test_body, parent_id=test_parent_id)
...
def test_create_page_with_message(confluence):
    ...
    confluence.create_page(space=test_space, title=test_title, body=test_body, update_message=test_update_message)
...
def test_update_page(confluence):
    ...
    confluence.api.content.put.assert_called_once_with(test_page_id, json=update_structure)
...
def test_update_page_with_message(confluence):
    ...
    confluence.update_page(test_page_object, body=test_new_body, update_message=test_page_message)
